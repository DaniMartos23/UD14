...
--
-- Host: 192.168.8.120    Database: ejercicio1
-- ------------------------------------------------------
...
CREATE TABLE `Muestra` (
  `fecha` char(30) DEFAULT NULL,
  `temp_min` int DEFAULT NULL,
  `temp_max` int DEFAULT NULL,
  `precipitaciones` int DEFAULT NULL,
  `hum_min` int DEFAULT NULL,
  `hum_max` int DEFAULT NULL,
  `vel_min` int DEFAULT NULL,
  `vel_max` int DEFAULT NULL,
  `id_muestra` char(20) NOT NULL
...
-- Dump completed on 2022-10-18 12:52:33
